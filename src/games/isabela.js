/* ============================================================
   isabela.js  --  Isabela & the Lost Heart of the Pink Kingdom
   ------------------------------------------------------------
   Encapsulated game cartridge module for HERMANIFY.
   Full original RPG quest with dialogues, secrets, maps, and ending!
   ============================================================ */
...
window.IsabelaGame = (() => {
  ...
  const HITBOX = { ox: 3, oy: 8, w: 10, h: 7 };
  ...
  function heroSprite() {
    ...
    if (!state.moving) return set[Math.floor(frame / 34) % 2 === 0 ? 0 : 2];
